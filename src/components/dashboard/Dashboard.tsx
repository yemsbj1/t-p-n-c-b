      ...
      <div className="flex flex-col">
        ...
        <div className="px-[16px] mb-4">
          {user.bank_details.balance_usd && (
            <div className="border flex flex-col gap-6 bg-[#414e58] text-white p-4 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/dashboard/transfer" className="p-[5px_20px] rounded-full bg-white text-[#414e58] text-[14px]">
                  Send money
                </Link>
              </div>
            </div>
          ...
          {user.bank_details.checking_balance_usd && (
            <div className="border flex flex-col gap-6 bg-[#414e58] text-white p-4 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-[14px] flex items-center gap-1">
                  Checking Balance
              ...
              <div className="flex items-center justify-between">
                <span className="font-[400] text-[20px]">{hideBalance ? '******' : `${formatCurrency(user.bank_details.checking_balance_usd)}`}</span>
                <Link href="/dashboard/transfer" className="p-[5px_20px] rounded-full bg-white text-[#414e58] text-[14px]">
                  Send money
                </Link>
              </div>
          ...
          {user.bank_details.saving_balance_usd && (
            <div className="border flex flex-col gap-3 bg-[#414e58] text-white p-4 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-[14px] flex items-center gap-1">
                  Saving Balance
                  {hideBalance ? <FiEyeOff onClick={toggleShowBalance} /> : <FiEye onClick={toggleHideBalance} />}
              ...
              <div className="flex items-center justify-between">
                <span className="font-[400] text-[20px]">{hideBalance ? '******' : `${formatCurrency(user.bank_details.saving_balance_usd)}`}</span>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="p-[16px] hidden border py-8">
          <div className="flex items-center justify-center gap-3">
            <Link href="/dashboard/cards" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#414e58] rounded-full">
              <CardIcon className="w-5 h-5" /> <span>Cards</span>
            </Link>
            <Link href="/dashboard/bill-payment" className="border flex items-center gap-1 p-4 py-2 text-[13px] max-w-max bg-white text-[#414e58] rounded-full">
